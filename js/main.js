...
document.addEventListener("DOMContentLoaded", function() {
    var columna1 = document.querySelector(".columna-1");
    var botonGo = document.querySelector(".boton-go");
    var animationPaused = false;

    botonGo.addEventListener("click", function() {
        if (animationPaused) {
            columna1.style.animationPlayState = "running"; // Reanudar la animación
            animationPaused = false;
        } else {
            columna1.style.animationPlayState = "paused"; // Pausar la animación
